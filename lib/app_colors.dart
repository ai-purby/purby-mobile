...
class AppColors {
  ...
  static const Color accent2 = Color(0x1A6B5CE7);
  static const Color gold    = Color(0xFFA07828);
  static const Color green   = Color(0xFF2A9C70);
  static const Color red     = Color(0xFFD94040);
  // 다크모드 대응 — getter
  static Color get bg    => isDark ? const Color(0xFF13111C) : const Color(0xFFF2F4F7);
  static Color get panel => isDark ? const Color(0xFF1C1A2A) : Colors.white;
  ...
  static Color get border      => isDark ? const Color(0x506B5CE7) : const Color(0xFFEAECF0);
